<?php
    ...
    if(!isset($_SESSION['is_login'])){
        if(isset($_REQUEST['rEmail'])){
            ...
            $sql = "SELECT r_email , r_password FROM requesterlogin WHERE r_email = '". $rEmail ."' AND r_password = '". $rPassword ."' limit 1";
...
<body>
    ...
    <p class="text-center" style="font-size: 20px;"><i class="fas fa-user-secret text-danger mx-2"></i>Requester Area
        (Demo)
    </p>
